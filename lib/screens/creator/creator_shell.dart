...
class _CreatorShellState extends State<CreatorShell> {
  ...
  void _setupNotificationListener() {
    FirebaseFirestore.instance
        ...
        .where('read', isEqualTo: false) // CHANGED: 'read' instead of 'isRead'
        .snapshots()
        .listen((snapshot) {
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: isWide ? null : _CreatorDrawer(
  ...
  BottomNavigationBar _buildBottomNav(BuildContext context) {
    final navItems = [
      ...
      },
      {
        ...
        'label': 'My Topics',
        'route': '/creator/topics',
        'badgeCount': 0,
      },
      {
        'icon': Icons.add_box,
        'label': 'Add',
        'route': '/creator/addContent',
        'badgeCount': 0,
      },
      {
        'icon': Icons.notifications_outlined,
        'label': 'Alerts',
        'route': '/creator/alerts',
...
class _CreatorDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final drawerItems = [
      {'icon': Icons.home_outlined, 'label': 'Home', 'route': '/creator/dashboard', 'index': 0, 'badgeCount': 0},
      {'icon': Icons.article_outlined, 'label': 'My Topics', 'route': '/creator/topics', 'index': 1, 'badgeCount': 0},
      {'icon': Icons.add_box, 'label': 'Add Topic', 'route': '/creator/addContent', 'index': 2, 'badgeCount': 0},
      {'icon': Icons.notifications_outlined, 'label': 'Alerts', 'route': '/creator/alerts', 'index': 3, 'badgeCount': unreadNotifications},
      {'icon': Icons.feedback_outlined, 'label': 'Feedback', 'route': '/creator/feedback', 'index': 4, 'badgeCount': 0},
      {'icon': Icons.help_outline, 'label': 'Help Center', 'route': '/creator/help', 'index': 5, 'badgeCount': 0},
      {'icon': Icons.exit_to_app, 'label': 'Logout', 'route': '/signin', 'index': 6, 'isLogout': true, 'badgeCount': 0},
    ];
