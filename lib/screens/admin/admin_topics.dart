...
class AdminTopics extends StatefulWidget {
  const AdminTopics({super.key});

  @override
  State<AdminTopics> createState() => _AdminTopicsState();
}

class _AdminTopicsState extends State<AdminTopics> {
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: "Search topics by title...",
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snap) {
                ...
                final docs = snap.data!.docs.where((e) {
                  ...
                  return (_query.isEmpty || t.contains(_query)) &&
                      ...
                      itemBuilder: (_, i) {
                        ...
                        return _TopicCard(
                          ...
                          onOpen: () => Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) =>
                                  TopicDetail(topicId: id, topicData: d),
                            ),
                          ),
                          onDelete: () async {
